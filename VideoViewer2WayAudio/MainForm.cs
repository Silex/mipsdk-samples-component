...
namespace VideoViewer2WayAudio
{
    public partial class MainForm : Form
    {
        ...
        private void InitializeAudioStreamToSpeaker(System.IO.Stream stream, bool initFromFile)
        {
        ...
        private void onBtnClick_Select_WAV_File(object sender, EventArgs e)
        {
            ...
            try
            {
                BeginInvoke(new MethodInvoker(delegate() { InitializeAudioStreamToSpeaker(soundFileStream, true); }));
            }
            catch (Exception ex)
            {
